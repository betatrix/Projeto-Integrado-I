            ...
            <Box sx={footerContent}>
                ...
                {!isMobile && (
                    <Box sx={footerColumn}>
                        ...
                        <Box sx={socialIcons}>
                            <IconButton href="https://www.youtube.com/@AdasTechIFSP" target="_blank" sx={{ color: '#6B9ABC', transition: '0.3s ease-in-out', '&:hover': {color: 'white'}}}>
                                <YouTube />
                            </IconButton>
                            <IconButton href="http://adastech.wordpress.com/" target="_blank" sx={{ color: '#6B9ABC', transition: '0.3s ease-in-out', '&:hover': {color: 'white'}}}>
                                <Article />
                            </IconButton>
                            <IconButton href="https://github.com/betatrix/Projeto-Integrado-I" target="_blank" sx={{ color: '#6B9ABC', transition: '0.3s ease-in-out', '&:hover': {color: 'white'}}}>
                                <GitHub />
                            </IconButton>
                        </Box>
                    </Box>
